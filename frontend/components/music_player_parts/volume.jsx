...
class Volume extends React.Component {
  ...
  render() {
    ...
    if(this.state.muted || this.state.volume === 0) {
      volumeLength = 0;
      volumeIcon = <button className="icon muted" onClick={this.toggleMute}>Volume</button>
    } else if(this.state.volume >= .5) {
      volumeIcon = <button className="icon high-volume" onClick={this.toggleMute}>Volume</button>
    } else {
      volumeIcon = <button className="icon low-volume" onClick={this.toggleMute}>Volume</button>
    }
